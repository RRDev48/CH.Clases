...
let USER_LOGED = recuperarUsuarioLogueado();
...
const MY_SESSION_TIME_OUT_ID = USER_LOGED && esperar();

const reestablecerEspera = () => {
  clearTimeout(MY_SESSION_TIME_OUT_ID);
  MY_SESSION_TIME_OUT_ID = esperar();
};
