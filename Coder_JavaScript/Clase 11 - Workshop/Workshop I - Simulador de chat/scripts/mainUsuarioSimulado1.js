...
let destinatario = localStorage.getItem("userName2");

// Creamos la referencia al formulario desde el cual vamos a obtener el nombre del usuario
...
FORMULARIO.addEventListener("submit", (event) => {
  ...
  definirNombreDeusuario(FORMULARIO, "userName1", userName);
});
...
MESSAGE_FORM.addEventListener("submit", (event) => {
  event.preventDefault();
  // Si el nombre del usaurio no es nulo, vamos a enviar su mensaje.
